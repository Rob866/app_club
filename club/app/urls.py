...
urlpatterns = [
    ...
    path('notificationsList/delete/<int:id>',views.deleteNotification,name="borrar-notificacion"),
    path('notificactionsList/vista/<int:id>/',views.notificacion,name='notificacion'),
