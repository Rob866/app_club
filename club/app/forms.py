...
class UserUpdateForm(forms.ModelForm):
    ...
    nombre_de_la_madre     = forms.CharField(label="Nombre de la Madre",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Nombre'}))
    edad_de_la_madre       = forms.IntegerField(label="Edad",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Edad'}))
    ocupacion_de_la_madre  = forms.CharField(label="Ocupación",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Ocupación'}))
    numero_de_la_madre     = forms.IntegerField(label="Número de Contacto",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Tel'}))
    nombre_del_padre     = forms.CharField(label="Nombre del Padre",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Nombre'}))
    edad_del_padre       = forms.IntegerField(label="Edad",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Edad'}))
    ocupacion_del_padre  = forms.CharField(label="Ocupación",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Ocupación'}))
    numero_del_padre     = forms.IntegerField(label="Número de Contacto",widget=forms.TextInput(attrs={ 'class':'form-control','placeholder':'Tel'}))
