    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(choices=[(True, 'Activo'), (False, 'Finalizado')], default=True, help_text='Elige el estado del paquete')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiempo_de_inicio', models.DateTimeField()),
                ('tiempo_de_salida', models.DateTimeField(blank=True, null=True)),
                ('observaciones', models.CharField(blank=True, max_length=200)),
                ('paquete_inscrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sesiones', to='app.Paquete_Inscrito')),
            ],
            options={
                'verbose_name': 'Sesion',
