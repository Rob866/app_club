...
class Usuario(AbstractBaseUser):
    ...
    nombre_madre =  models.CharField(verbose_name="Nombre de la Madre",max_length=100,blank=True, null=True)
    edad_madre =  models.IntegerField(verbose_name="Edad",blank=True, null=True)
    ocupacion_madre = models.CharField(verbose_name="Ocupación",max_length=100,blank=True,null=True)
    numero_madre   =  models.IntegerField(verbose_name="Número de contacto",blank=True,null=True)
    nombre_padre =  models.CharField(verbose_name="Nombre del Padre",max_length=100,blank=True, null=True)
    edad_padre =  models.IntegerField(verbose_name="Edad",blank=True, null=True)
    ocupacion_padre = models.CharField(verbose_name="Ocupación",max_length=100,blank=True, null=True)
    numero_padre    =  models.IntegerField(verbose_name="Número de contacto",blank=True,null=True)
